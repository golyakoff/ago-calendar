...
///
/// <para>This product has a sharper stake in the rule than AGO Chat does: a booking calendar
/// renders in a shop's own IANA zone and reasons about future instants, so a stray ambient
/// <c>.Now</c> would be a business bug, not only an untestable one.</para>
/// </summary>
